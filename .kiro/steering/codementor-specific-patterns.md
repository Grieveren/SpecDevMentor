...
interface PhaseValidator {
  ...
  validatePhaseCompletion(phase: SpecificationPhase, document: SpecificationDocument): ValidationResult;
      ...
      {phases.map((phase, index) => (
        <div key={phase} className="flex items-center">
          <div className={cn(
            ...
            !completedPhases.includes(phase) && phase !== currentPhase && "bg-gray-200 text-gray-600"
          )}>
