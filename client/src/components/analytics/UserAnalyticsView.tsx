...
import { TimeRange, UserAnalytics } from '../../services/analytics.service';
...
export const UserAnalyticsView: React.FC<UserAnalyticsViewProps> = ({
  ...
  const getTopActivity = () => {
    ...
    const topActivity = activities.reduce((max, current) => (current[1] > max[1] ? current : max));
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricCard
          ...
          value={`${Math.round(
            (analytics.learningProgress.modulesCompleted /
              analytics.learningProgress.totalModules) *
              100
          )}%`}
          icon={BookOpenIcon}
          color="orange"
        ...
        <div className="p-6">
          {analytics.skillLevels.length > 0 ? (
                ...
                <div key={skill.skillArea} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4 text-sm">
                      <span className="text-gray-600">{skill.currentLevel.toFixed(1)}</span>
                      <span
            ...
            <div className="text-center py-8 text-gray-500">
              No skill assessments available yet. Complete some projects to see your skill
              development!
            </div>
          )}
        </div>
          ...
          <div className="p-6">
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-semibold text-gray-900">{getMostActiveHour()}</span>
              </div>
              <div className="flex justify-between items-center">
      ...
      <div className="bg-white rounded-lg shadow">
        ...
        <div className="p-6">
          {Object.keys(analytics.activitySummary.activityBreakdown).length > 0 ? (
            ...
            <div className="text-center py-8 text-gray-500">No activity data available yet</div>
          )}
        </div>
      </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    Complete your first project to start building your skill profile and track your
                    progress.
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-green-700 mt-1">
                    Your specifications consistently meet high quality standards. Keep up the great
                    work!
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-yellow-700 mt-1">
                    You're making good progress! Complete more learning modules to further develop
                    your skills.
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-red-700 mt-1">
                    Some of your skills are showing decline. Consider reviewing learning materials
                    or seeking additional practice.
                  </p>
                </div>
              </div>
            </div>
